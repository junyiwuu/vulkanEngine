...
void KeyboardMovementsController::moveInPlaneXZ (GLFWwindow *window , float dt, LveGameObject& gameObject){
    ...
    //determine which direction you are facing. 
    float yaw = gameObject.transform.rotation.y;
    const glm::vec3 forwardDir{sin(yaw), 0.f, cos(yaw)};  //yaw is the angle of z axis and rotation on Y axis
    ...
    //check the moveDir vector is non-zero
